...
export default function Drafting() {
  ...
  const checkAuth = () => {
    ...
    if (!token || !user) {
      console.log('❌ [DRAFTING] No auth found, redirecting to login');
      router.push('/auth');
      return;
    }
    ...
    try {
      ...
      console.error('❌ [DRAFTING] Error parsing user data:', error);
      localStorage.clear();
      router.push('/auth');
    }
  };
    ...
    <div className="dashboard-container">
      ...
      <aside className="sidebar">
        ...
        <nav className="sidebar-nav">
          ...
          <a href="/drafting" className="nav-item active">
            <svg width="20" height="20" viewBox="0 0 20 20" fill="currentColor">
      ...
      <main className="main-content">
        <header className="dashboard-header">
          ...
          <div className="header-actions">
            <div className="search-box">
              ...
              <input type="text" placeholder="Search templates, drafts..." />
            </div>
        ...
        <div className="drafting-content">
          {/* Blank content area - to be filled with drafting features */}
          <div className="blank-state">
            ...
            <p>Create contracts, petitions, and legal notices</p>
          </div>
        </div>
      </main>
    </div>

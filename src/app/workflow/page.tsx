...
export default function Workflow() {
  ...
  const checkAuth = () => {
    ...
    if (!token || !user) {
      console.log('❌ [WORKFLOW] No auth found, redirecting to login');
      router.push('/auth');
      return;
    }
    ...
    try {
      ...
      console.error('❌ [WORKFLOW] Error parsing user data:', error);
      localStorage.clear();
      router.push('/auth');
    }
  };
    ...
    <div className="dashboard-container">
      ...
      <aside className="sidebar">
        ...
        <nav className="sidebar-nav">
          ...
          <a href="/workflow" className="nav-item active">
            <svg width="20" height="20" viewBox="0 0 20 20" fill="currentColor">
      ...
      <main className="main-content">
        ...
        <div className="workflow-content">
          {/* Blank content area - to be filled with workflow features */}
          <div className="blank-state">
            ...
            <p>Automate your legal processes from intake to filing</p>
          </div>
        </div>
      </main>
    </div>
